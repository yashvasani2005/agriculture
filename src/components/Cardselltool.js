        ...
        <div>
            ...
            <form className="sellingform">
                <table align="center" cellpadding="10">
                    <tr>
                        <td>First Name :</td>
                        <td><input type="text" name="FirstName" id="fname" maxLength="50" placeholder="Yash" />
                            (Max 50 Characters Allowed)
                        </td>
                    </tr>
                    <tr>
                        <td>Last Name :</td>
                        <td><input type="text" name="LastName" id="lname" maxLength="50" placeholder="Vasani" />
                            (Max 50 Characters Allowed)
                        </td>
                    </tr>
                    <tr>
                        <td>Email ID :</td>
                        <td><input type="email" name="EmailID" id="email" maxLength="100" placeholder="abcdefgh@gmail.com" /></td>
                    </tr>
                    <tr>
                        <td>Mobile Number :</td>
                        <td>
                            <input type="text" name="MobileNumber" id="mo_no" maxLength="10" placeholder="7842xxxxxx" />
                            (10 Digits Allowed)
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="BirthDay" id="dob" className="dob">
                    ...
                    <tr>
                        <td>pieace :</td>
                        <td><input type="number" name="Stock" id="stock" placeholder="1" /></td>
                    </tr>
